...
Name:      qubes-mgmt-salt-dom0-fix-permissions
Version:   %{version}
Release:   1%{?dist}
...
qubesctl top.disable fix-permissions saltenv=dom0 -l quiet --out quiet > /dev/null || true

%files
%defattr(-,root,root)
%doc LICENSE README.rst
%attr(750, root, root) %dir /srv/formulas/dom0/fix-permissions-formula
/srv/formulas/dom0/fix-permissions-formula/*
